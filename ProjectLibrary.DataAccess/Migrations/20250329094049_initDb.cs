        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StatsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TotalBorrowed = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    ReturnedOnTime = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    LateReturns = table.Column<int>(type: "int", nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewReturnDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Pending")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtensionRequests", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_ExtensionRequests_BorrowedBooks_BorrowId",
                        column: x => x.BorrowId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtensionRequests_BorrowId",
